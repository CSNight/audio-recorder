/**
 * Build FFmpeg AC-3 / E-AC-3 WASM module
 */
...
const BUILD_DIR = join(CACHE_DIR, `ffmpeg-${FFMPEG_VERSION}-build-ac3`)
const WRAPPER_C = join(projectRoot, "scripts/native/ac3_wasm_wrapper.c")
const OUTPUT_PATH = join(projectRoot, "src/codecs/ac3/libac3.wasm.mjs")

const SIMD_FLAGS = getWasmSimdFlags("ac3", false)
...
export async function buildAc3() {
  console.log(`Building FFmpeg AC-3 ${FFMPEG_VERSION} WASM module...`)
  ...
  console.log("Configuring FFmpeg AC-3...")
  ...
  console.log("Building FFmpeg AC-3...")
  const jobs = getBuildJobs("FFMPEG_AC3_WASM_BUILD_JOBS")
  ...
  await emcc(
    [
      ...
      "MODULARIZE=1",
      "-s",
      "EXPORT_NAME=createLibAc3Module",
      "-s",
      "SINGLE_FILE=1",
      "-s",
      "WASM_BIGINT=1",
