...
`@media-studio/audio-recorder` 提供一套面向 Web 应用的浏览器录音能力，适合以下场景：
...
| `@media-studio/audio-recorder/codecs/opus`                 | Opus 编码器                                                                    |
| `@media-studio/audio-recorder/codecs/aac`                  | AAC 编码器                                                                     |
| `@media-studio/audio-recorder/codecs/amr`                  | AMR 编码器                                                                     |
| `@media-studio/audio-recorder/codecs/ac3`                  | AC3 / E-AC3 编码器                                                             |
| `@media-studio/audio-recorder/codecs/g711`                 | G.711 编码器                                                                   |
...
以下运行时与事件类型从 `@media-studio/audio-recorder/plugins/level-meter` 子路径导出。
...
以下 API 从 `@media-studio/audio-recorder/plugins/dsp` 子路径导出。
...
以下类型从 `@media-studio/audio-recorder/plugins/asr-export` 子路径导出。
...
`@media-studio/audio-recorder/plugins/frequency-histogram` 导出：
...
`@media-studio/audio-recorder/plugins/dtmf` 导出：
...
`@media-studio/audio-recorder/plugins/nmn2pcm` 导出：
...
`@media-studio/audio-recorder/plugins/streaming-player` 导出：
